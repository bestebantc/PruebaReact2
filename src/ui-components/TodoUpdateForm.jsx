...
export default function TodoUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = todoRecord
      ...
      : initialValues;
    setS1(cleanValues.s1);
    setS2(cleanValues.s2);
    setS3(cleanValues.s3);
    setS4(cleanValues.s4);
    setS5(cleanValues.s5);
    setS6(cleanValues.s6);
    setS7(cleanValues.s7);
    setS8(cleanValues.s8);
    setS9(cleanValues.s9);
    setS10(cleanValues.s10);
    setErrors({});
  };
